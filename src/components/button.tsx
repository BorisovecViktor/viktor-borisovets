...
export const Button = (
  ...
  return (
    <button
      className={twMerge(
        'relative group/button h-11 px-6 rounded-xl border border-red-orange-500 uppercase inline-flex items-center justify-center gap-2 transition-colors duration-300 ease-linear cursor-pointer',
        variant === 'primary' &&
